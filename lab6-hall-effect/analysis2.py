...
# Calculate thickness 
seperation = (8 / 89.65)  # meters
step_size = 1.28

thickness = step_size*seperation * 2945E-10 
thickness_err = tools.error_mult(2945E-10, 8 / 89.65, 0, 0.005, sol=thickness)

# Currents and voltages 
currents = [31.04,24.57,20.5,14.95,9.76]  # in mA

voltages = {
    1148: [0.0229,0.0186,0.0152,0.0115,0.0074],  # in mV
}
