...
initial_guess = 8
bb.plot_fit(proportional, dT, N, dT_err, N_err, init_guess=initial_guess, font_size=12, xlabel="Temperature change (K)", ylabel="Number of fringes")

m_fit, m_fit_err = 8.975206611178253, 0.031597764987057374
a = m_fit * l / 2 / L0
